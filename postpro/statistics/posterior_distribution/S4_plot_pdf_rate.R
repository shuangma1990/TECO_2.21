...
# filename=c('fcast2_r4')
# filename=c('fcast2_r6')
# filename=c('CS1722')
# filename=c('from_nau')
filename=c('finalfluxes')
...
y <- 1/y
yvalue <- as.vector(y)
plot(xsoil,yvalue,col=caf,lwd=3 ,pch=16, cex=pointcex, ylim=c(0,1/10), xlim=c(0,12),main=NA, axes=F, ann=F)
# plot(xsoil,yvalue,col=caf,lwd=3 ,pch=16, cex=pointcex, ylim=c(0,1/200), xlim=c(0,12),main=NA, axes=F, ann=F)
axis(side=1, labels=T, tck=0.03, las=1,mgp=c(3, 0.3,0), at=c(0,5,10,15,20))
axis(side=2, labels=T, tck=0.03, las=1,mgp=c(3, 0.3,0), at=c(seq(from=0,to=1/10,by=1/20)))
model3 <- lm(yvalue~ xsoil)
summary(model3)
newdata <- data.frame(xsoil=seq(0,20,0.01))
newdata$pred1 <- predict(model3,newdata)
lines(smooth.spline(newdata$xsoil,newdata$pred1),col=caf,lwd=1,lty=2)
box()
Texp <- expression(paste("(h)",k[socS],sep=''))
...
plot(xsoil,yvalue,col=caf,lwd=3 ,pch=16, cex=pointcex, ylim=c(1/2,1/0.2), xlim=c(0,12),main=NA, axes=F, ann=F)
axis(side=1, labels=T, tck=0.03, las=1,mgp=c(3, 0.3,0), at=c(0,5,10,15,20))
...
# lines(smooth.spline(newdata$xsoil,newdata$pred1),col=caf,lwd=1,lty=2)
box()
Texp <- expression(paste("(i)",k[root],sep=''))
mtext(side=1, text=Texp, line=-7.5, cex=0.98,at=3)
slope=round(as.numeric(model3$coefficients[2]),digit=4)
mtext(side=1,text=paste("m=",slope,sep=''),line=-6,cex=0.85,at=8.)
...
# plot(xair,yvalue,col=caf,lwd=3 ,pch=16, cex=pointcex, ylim=c(1/1.5,1/0.3), xlim=c(0,20),main=NA, axes=F, ann=F)
plot(xair,yvalue,col=caf,lwd=3 ,pch=16, cex=pointcex, ylim=c(0,5), xlim=c(0,20),main=NA, axes=F, ann=F)
...
lines(smooth.spline(newdata$xair,newdata$pred1),col=caf,lwd=1,lty=2)
box()
Texp <- expression(paste("(j)",k[leaf],sep=''))
...
mtext(side=1, text=Texp, line=-7.5, cex=0.98,at=3)
slope=round(as.numeric(model3$coefficients[2]),digit=3)
mtext(side=1,text=paste("m=",slope,'*',sep=''),line=-6,cex=0.85,at=9.)
