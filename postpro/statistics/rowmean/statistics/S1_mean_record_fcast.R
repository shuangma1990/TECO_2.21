...
n=c('_CS1722_arv','_CS1722_arv','_CS1422_arv','_CS1623_arv','_CS1422_arv','_CS1622_arv') #r4
n=c(rep('_CS1722_arv',6))
...
write.csv(ddff, file = paste("mean_record_fcast2_r6.csv",sep=''))
