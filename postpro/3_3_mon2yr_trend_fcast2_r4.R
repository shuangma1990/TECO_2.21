...
for(i in 1:6){
  ...
  df11 <- df1[c(12,24,36,48,60,72,84,96),c(18:25,42:51)] # Cpools end of year  
  dfmean9 <- df1[c(12,24,36,48,60,72,84,96)-3,c(18:25,42:51)] # Cpools end of growing season, end of September
  dfmean4 <- df1[c(12,24,36,48,60,72,84,96)-8,c(18:25,42:51)] # Cpools start of growing season, end of April
  ...
  df21 <- df2[c(12,24,36,48,60,72,84,96),c(18:25,42:51)] # Cpools sd, end of
  dfsd9 <- df2[c(12,24,36,48,60,72,84,96)-3,c(18:25,42:51)] # Cpools sd, end of growing season, end of September
  dfsd4 <- df2[c(12,24,36,48,60,72,84,96)-8,c(18:25,42:51)] # Cpools start of growing season, end of April
  df22 <- aggregate(df2[,c(4:17,26:42)],by=list(df2$year),FUN=sum)   # Cfluxes sd
