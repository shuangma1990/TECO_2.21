...
setwd(paste("/projects/eco_luo/sm3323/TECO_SPRUCE_2.2/run/f1p1_MCMC",n[1],"/output/",sep = ""))
# setwd('E:/Netbeans_Project/TECO_SPRUCE_2.2_acclimation_server/scripts_on_server/Rscript_on_server')
data1=read.table('Paraest.txt',header = F,skip =skn,sep = ',')
# data1=data1[1:2000,]
...
# k="MCMC_CS40"
# n="_CS40"
setwd(paste("/projects/eco_luo/sm3323/TECO_SPRUCE_2.2/run/f1p2_MCMC",n[2],"/output/",sep = ""))
data2=read.table('Paraest.txt',header = F,skip =skn,sep = ',')
# data2=data2[1:2000,]
...
# k="MCMC_CS41"
# n="_CS41"
setwd(paste("/projects/eco_luo/sm3323/TECO_SPRUCE_2.2/run/f1p3_MCMC",n[3],"/output/",sep = ""))
data3=read.table('Paraest.txt',header = F,skip =skn,sep = ',')
# data3=data3[1:2000,]
...
# k="MCMC_CS40"
# n="_CS40"
setwd(paste("/projects/eco_luo/sm3323/TECO_SPRUCE_2.2/run/f1p4_MCMC",n[4],"/output/",sep = ""))
data4=read.table('Paraest.txt',header = F,skip =skn,sep = ',')
# data4=data4[1:2000,]
...
# k="MCMC_CS40"
# n="_CS40"
setwd(paste("/projects/eco_luo/sm3323/TECO_SPRUCE_2.2/run/f1p5_MCMC",n[5],"/output/",sep = ""))
data5=read.table('Paraest.txt',header = F,skip =skn,sep = ',')
# data5=data5[1:2000,]
...
# k="MCMC_CS38"
# n="_CS38"
setwd(paste("/projects/eco_luo/sm3323/TECO_SPRUCE_2.2/run/f1p6_MCMC",n[6],"/output/",sep = ""))
data6=read.table('Paraest.txt',header = F,skip =skn,sep = ',')
# data6=data6[1:2000,]
...
plot(data1.gddonset,col=coul[1],xlim = c(100,160.),ylim = c(0,0.08),main = NA)
...
data2.Tau_Root = density (data2$Tau_Root, adjust = adjnum)
