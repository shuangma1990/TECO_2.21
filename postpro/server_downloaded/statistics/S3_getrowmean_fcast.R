...
#### create dataframe for saving ####
  ...
  df2 = data.frame(GPP_sd1,NPP_sd1,Reco_sd1,NEE_sd1,Rh_sd1,Ra_sd1,
                   ...
                   QCt1_sd1,QCt2_sd1,QCt3_sd1,QCt4_sd1,QCt5_sd1,QCt6_sd1,QCt7_sd1,QCt8_sd1,QCt9_sd1,QCt10_sd1,
                   NPPL_sd1,NPPR_sd1,NPPS_sd1,add_sd1,
...
write.csv(df1, file = paste('rowmean_',a[i],'_fcast2_r5.csv',sep=''))
write.csv(df2, file = paste('rowsd_',a[i],'_fcast2_r5.csv',sep=''))
}
