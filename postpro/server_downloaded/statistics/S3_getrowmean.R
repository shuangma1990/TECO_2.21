...
CS<-c('_MCMC_CS1722_arv','_MCMC_CS1722_arv','_MCMC_CS1422_arv','_MCMC_CS1622_arv','_MCMC_CS1422_arv','_MCMC_CS1622_arv')
...
####  for 1-6 ####
for(i in 2:2){
  smwd=paste("/scratch_lg/cardamom/shuangma/TECO/TECO_2.21/src/output/SPRUCE/",a[i],CS[i],sep = "")
  setwd(smwd)
