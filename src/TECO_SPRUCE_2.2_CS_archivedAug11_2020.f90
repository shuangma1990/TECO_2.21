...
!          end if
              ...
              m=m+1
                 ...
                 if(gpp .gt. -999)then
					 if (use_plinit .eq. 11 .or. use_plinit .eq. 12 .or. use_plinit .eq. 14) then
						std_cflux_hr(4,m)= 0.016
					 else				 
						std_cflux_hr(4,m)= 0.024!gpp 0.64!1.94!0.64 !0.5! 		! option B
					 endif
					!if (gpp .ne. 0.) then
			...
			!endif
              ...
              if(nee .gt. -999)then
				if (use_plinit .eq. 11 .or. use_plinit .eq. 12 .or. use_plinit .eq. 16) then				 
					std_cflux_hr(5,m)= 0.024!nee 0.34!0.34 !0.5!0.94          ! option B
				else
					std_cflux_hr(5,m)= 0.024
				endif 				
              else
			...
			!endif
                 if(reco .gt. -999)then
					 if (use_plinit .eq. 11 .or. use_plinit .eq. 12) then
						std_cflux_hr(6,m)= 0.0064
					 else
						std_cflux_hr(6,m)= 0.008
			...
			!endif
                 ...
                 if(CH4_flux .gt. -999)then
					if (use_plinit .eq. 11 .or. use_plinit .eq. 12) then
						std_cflux_hr(7,m)= 0.0032
					else
						std_cflux_hr(7,m)= 0.004! ch4 0.34!0.34 !0.5!.94	      ! option B
					endif
...
!       stdm=0.01
		...
		if (use_plinit .eq. 11 .or. use_plinit .eq. 12 .or. use_plinit .eq. 13) then
        stdm=1.6!stdm shallow layer conc std
		stdmc=1.6!stdmc deep layer conc std
		elseif (use_plinit .eq. 14) then
		stdm=2.
		stdmc=2.
		else
