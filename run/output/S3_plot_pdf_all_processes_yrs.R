...
setwd('~/RESEARCH/TECO_SPRUCE_site/TECO_2.21_Dissertation/jpl_server/TECO_2.21/run/output/server_downloaded')
...
# openfile2= paste("peak_record",n2[1],".csv",sep='')
...
pdf(paste("~/RESEARCH/TECO_SPRUCE_site/TECO_2.21_Dissertation/jpl_server/TECO_2.21/run/output/",filename,"linear_pdf_mixpeakmean.pdf",sep=''),width=9., height=4.5, compress=FALSE)
# dev.off()
#### plot c flux figures ####  
print('start to plot')
